...
import { SiMongodb, SiFlutter, SiDocker, SiSqlite, SiHtml5, SiCss3, SiJavascript} from 'react-icons/si';
    ...
    <div className="pb-24">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="border p-6 rounded-lg shadow-lg">
          <h3 className="text-2xl font-semibold text-center">Web Development</h3>
          <p className="my-4 text-center text-gray-600">
            Teknologi yang digunakan untuk membangun website frontend dan backend.
          </p>
        ...
        <div className="border p-6 rounded-lg shadow-lg">
          ...
          <p className="my-4 text-center text-gray-600">
            Tools dan framework untuk mengembangkan aplikasi desktop dan backend.
          </p>
          <div className="flex justify-center gap-4 mt-6">
            <FaPython className="text-7xl text-blue-500" title='Python'/>
            <FaJava className="text-7xl text-red-600" title='Java'/>
            <img src='https://raw.githubusercontent.com/danielcranney/readme-generator/main/public/icons/skills/csharp-colored.svg 'className="text-7xl text-blue-500" title='C#' width={70}/>
          </div>
        </div>

        {/* Mobile Development */}
        <div className="border p-6 rounded-lg shadow-lg">
          <h3 className="text-2xl font-semibold text-center">Mobile Development</h3>
          <p className="my-4 text-center text-gray-600">
